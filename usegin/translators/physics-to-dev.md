...
## Format (when entries arrive)

| Physics term | Dev meaning | First seen | Confirmed by Lihu? |
|---|---|---|---|

## How Gin uses this

When Lihu uses a term that I think might be physics-domain:

1. Best-guess the meaning inline.
2. Flag it in my response: `[physics?]` next to the term.
3. When Lihu confirms (or corrects), add the entry here.

No interrupt-and-ask pattern — it stalls the conversation and is the kind of friction z009 says to lower.
